...
// bookmark-manager/Basalt, and redirector so every service looks like one
// platform. (Was the old flat Apple-HIG greyscale; re-pointed to the blue
// palette — keys are unchanged so every admin screen picks up the new values.)
export const COLORS = {
