...
export default function Login({ isOffline, onLoggedIn }: Props) {
      ...
      >
        ...
        >
          {hasPasskey
            ...
            : 'No Citrine passkey registered yet'}
        </p>
        ...
        {isOffline && (
          <div
            ...
            role="status"
          >
            Sign-in needs a connection. Installed Citrine still preserves local work already saved on this device.
          </div>
        )}
        ...
        <button
          ...
          onClick={() =>
            window.location.assign(
              '/services/admin/?return=/services/citrine/',
            )
          }
          disabled={isOffline}
          className="w-full rounded-xl py-3 text-white font-semibold flex items-center justify-center gap-2 disabled:opacity-50"
          style={{
        ...
        {hasPasskey && (
          <button
            type="button"
            onClick={onPasskey}
            disabled={submitting || !supported || isOffline}
